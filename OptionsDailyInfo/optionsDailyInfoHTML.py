...
def main(year, month, day):
    ...
    filepath = f'OptionsDailyInfo-{year}{month:02}{day:02}.csv'
    filename = f'{filepath}'
    ...
    loguru.logger.warning(f'OptionsDailyInfo: {filename} is saving...')
    ...
    with open(filepath, mode='w', newline='', encoding='utf-8-sig') as f:
        ...
        for optionsDailyInfo in optionsDailyInfosPut+optionsDailyInfosCall:
            for options in optionsDailyInfo:
                writer.writerow([
                    options.ContractYear,
                    options.ContractMonth,
                    options.ContractWeek,
                    options.StrikePrice,
                    options.CallPut,
                    options.Open,
                    options.High,
                    ...
                    options.Change,
                    options.Percent,
                    options.VolumeAfterHours,
                    options.VolumeRegular,
                    options.VolumeTotal,
                    options.OpenInterest,
                    options.BestBid,
                    options.BestAsk,
                    options.HistoricalHigh,
